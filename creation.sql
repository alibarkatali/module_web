...
ALTER TABLE Offre ADD CONSTRAINT FK_Offre_pl_id FOREIGN KEY (pl_id) REFERENCES Player(pl_id);
ALTER TABLE Offre ADD CONSTRAINT FK_Offre_rec_id FOREIGN KEY (rec_id) REFERENCES Recipe(rec_id);
